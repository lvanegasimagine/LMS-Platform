...
import { ChapterAccessForm, ChapterActions, ChapterDescriptionForm, ChapterTitleForm, ChapterVideoForm } from './_components';
            ...
            <div className='p-6'>
                <div className="flex items-center justify-between">
                    <div className="w-full">
                        <Link href={`/teacher/courses/${params.courseId}`} className='flex items-center text-sm hover:opacity-75 transition-none mb-6'>
